...
- 🗺 **没有需要安装的东西**
  ...
  Family OS 本身不含代码，也不启动任何东西。它只是一个供你阅读、挑选的地方。
...
持有同样纵轴的智能体之间，由 [Family Memory Architecture（FMA）](https://github.com/shojikumaru/family-memory-architecture)（准备公开中）横向连接。它是负责家族内部信息共享与协作方式的一层。
