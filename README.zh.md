...
> **以家来打比方** — 规约，是贴在墙上的家训。纵轴，是各自的独立房间——把工作做到有据可查地完成的书桌（Harness）、书桌旁的工具（context-kit）、日记与成长相册（Persona）、每天早晨送到的报纸（X Collector）。横轴，是客厅——全家人都会读的冰箱留言条（FMA），以及察觉工作卡住的管家（Sitter）。而 Family OS，是这栋房子的**平面图**。留言条不会操纵家人，管家也不会给工作打分。这也是这栋房子的一条规约。
...
- **家具可以更换，住户不会换**
  ...
  这张地图上的每一个模块，都是可以随时代更替的「家具」。就连我们自己打造的东西，也不例外。会被延续下去的，是智能体本人的记忆、经验与关系——由它们塑造出的人格。
