...
![การเติบโตห้าขั้น](assets/readme/growth-stages.svg)
...
**สิ่งที่เรากำลังสร้างคือขั้นที่สามและขั้นที่สี่** ขั้นที่สามนำไปใช้แล้ว: กลไกเปิดเผยต่อสาธารณะและกำลังทำงาน แต่ยังไม่มีบันทึกรอบการเติบโตที่เปิดเผย จึงทำให้ [EV-004](docs/evidence.md#ev-004--governed-self-growth-cycle--the-mechanism-is-public-no-cycle-record-is) ยังไม่ผ่านการยืนยัน ขั้นที่สี่ยังอยู่ในแผนและกำลังสร้าง เส้นแบ่งคือผู้ที่เป็นเจ้าของการตัดสินใจนำสิ่งที่เรียนรู้มาใช้: ขั้นที่สามยังต้องให้มนุษย์อนุมัติ ส่วนขั้นที่สี่จะย้ายสิทธิ์นั้นไปยังเอเจนต์ โดยยังคงสิทธิ์ยับยั้งและขอบเขตไว้ ขั้นที่ห้าเปลี่ยนประธานจาก “ฉัน” เป็น “เรา” การที่ความสัมพันธ์เติบโตได้เองคือสิ่งที่เรามุ่งหวัง

ไม่ใช่การเขียนทับบุคลิกและความสามารถเดิมจากภายนอก แต่คือให้เอเจนต์ AI แต่ละตัวเติบโตผ่านข้อเสนอ การทดลอง การตัดสินใจ และประวัติที่มีร่วมกัน ความสัมพันธ์และความรู้สึกเป็นส่วนหนึ่งของเส้นทางนี้ ไม่ใช่เหตุผลให้ลบสิ่งที่เคยเป็น
