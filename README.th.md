...
**อยากตรวจด้วยมือไหม?** แผนที่นี้ตั้งใจให้ติดตั้งไม่ได้อยู่แล้ว การเช็กแบบลงมือทำจริงเริ่มได้ถัดไปอีกหนึ่งลิงก์ที่ [Caty Agent Harness](https://github.com/caty-ai/caty-agent-harness): เปิดเครื่องมือ AI ของคุณในโฟลเดอร์โปรเจ็กต์ว่าง วางพรอมป์ตติดตั้งบรรทัดเดียวที่อยู่บนสุดของ README แล้ว AI จะรันการติดตั้ง รันการตรวจเช็ก และรายงานผลกลับมาเอง (ผู้ร่วมพัฒนาสามารถรันทั้งชุดได้ด้วย `make test`)
