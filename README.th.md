...
> **เปรียบเหมือนบ้านหนึ่งหลัง** — กฎ คือคำสอนของครอบครัวที่แปะไว้บนผนัง แกนตั้ง คือห้องส่วนตัวของแต่ละคน — โต๊ะที่ทำงานจนเสร็จอย่างตรวจสอบได้ (Harness) เครื่องมือข้างโต๊ะ (context-kit) ไดอารีและอัลบั้มแห่งการเติบโต (Persona) หนังสือพิมพ์ที่มาส่งทุกเช้า (X Collector) แกนนอน คือห้องนั่งเล่น — โน้ตติดตู้เย็นที่ทุกคนในครอบครัวอ่าน (FMA) และพี่เลี้ยงที่คอยสังเกตเมื่องานหยุดชะงัก (Sitter) และ Family OS คือ**ผังบ้าน**ของบ้านหลังนี้ โน้ตติดตู้เย็นไม่เคยสั่งการใคร และพี่เลี้ยงไม่เคยตัดสินคะแนนงาน นั่นก็เป็นกฎข้อหนึ่งของบ้านหลังนี้เช่นกัน
...
- [Persona Growth Loop](https://github.com/caty-ai/persona-growth-loop) (เปิดแล้ว・MIT) — ผลักดันการเติบโตอย่างเป็นอิสระของบุคลิก ใช้งานแล้ว (การเขียนกลับไปยัง Persona Engine ยังอยู่หลังประตูอนุมัติ)
...
| เครื่องมือ registry และตรวจสอบลิงก์ | ✅ Linux ／ ✅ macOS (รันบน CI ทั้งสองระบบทุกครั้งที่มีการเปลี่ยนแปลง) ／ ✅ WSL2 (ครอบคลุมโดยการตรวจสอบบน Ubuntu; ให้ clone ไว้ใต้ `~` บน ext4 ไม่ใช่ `/mnt/c`) | 2026-08-25 |
...
ไม่ว่า Family OS จะขยายไปไกลแค่ไหน หกข้อนี้จะไม่เปลี่ยน
...
- **เปลี่ยนเฟอร์นิเจอร์ได้ แต่ไม่เปลี่ยนตัวผู้อาศัย**

  โมดูลทุกตัวบนแผนที่นี้คือ "เฟอร์นิเจอร์" ที่เปลี่ยนได้ตามยุคสมัย แม้แต่สิ่งที่เราสร้างขึ้นเองก็ไม่มีข้อยกเว้น สิ่งที่จะพกต่อไปคือความทรงจำ ประสบการณ์ และความสัมพันธ์ของตัวเอเจนต์เอง — และบุคลิกที่สิ่งเหล่านั้นหล่อหลอมขึ้นมา
