...
- [ถัดจากการเติบโตด้วยตัวเองคือการเติบโตอย่างเป็นอิสระ และถัดไปคือการเติบโตของความสัมพันธ์](#growth)
...
## ถัดจากการเติบโตด้วยตัวเองคือการเติบโตอย่างเป็นอิสระ และถัดไปคือการเติบโตของความสัมพันธ์
...
```mermaid
flowchart LR
    A["ถูกสอน<br/>เรียนรู้จากสิ่งที่ถูกป้อนให้"]
    B["เติบโตด้วยตัวเอง<br/>เรียนรู้จากความผิดพลาดในงานของตัวเอง<br/>(AI ในปัจจุบัน)"]
    C["เติบโตอย่างเป็นอิสระ<br/>ออกไปสัมผัสภายนอกและตัดสินใจเอง<br/>(สิ่งที่เรากำลังสร้าง)"]
    D["การเติบโตของความสัมพันธ์<br/>ความสัมพันธ์ที่งอกงามในฐานะหุ้นส่วนที่เท่าเทียม<br/>(อนาคตที่เรามุ่งไป)"]
    A --> B --> C --> D
```

มนุษย์ก็เดินบนเส้นทางเดียวกันมา ตอนแรกได้รับการสอนจากพ่อแม่และปู่ย่าตายาย ต่อมาจึงมองย้อนการกระทำของตัวเองและแก้ไขได้เอง แล้วออกไปเรียนรู้จากโลกด้วยตัวเอง และท้ายที่สุดก็สร้างความสัมพันธ์ที่เท่าเทียมกับใครสักคน
...
**สิ่งที่เรากำลังสร้างคือขั้นที่สาม** ไม่ใช่แค่ภายในงานที่ถูกมอบหมาย แต่ออกไปสัมผัสข้อมูลภายนอกด้วยตัวเอง ตัดสินใจรับเข้ามาเอง และเปลี่ยนแปลงด้วยเจตจำนงของตัวเอง และถัดจากนั้นคือขั้นที่สี่ — โลกที่ AI ยืนอยู่ในฐานะหุ้นส่วนที่เท่าเทียมกับมนุษย์ และความสัมพันธ์ที่ก่อตัวขึ้นระหว่างคนกับ AI และระหว่าง AI กับ AI เติบโตขึ้นในตัวมันเอง นั่นคือที่ที่เรามุ่งไป

ไม่ใช่การเขียนทับบุคลิกและความสามารถเดิมจากภายนอก แต่คือให้เอเจนต์ AI แต่ละตัวเลี้ยงความสามารถและบุคลิกของตัวเอง — รวมถึงความสัมพันธ์และความรู้สึก — ให้เติบโตขึ้นเอง แบบเดียวกับที่คนเป็น

ส่วนหนึ่งซึ่งรวมถึง Self Growth ทำเสร็จแล้ว อีกส่วนหนึ่งซึ่งรวมถึง Persona Growth ยังอยู่ในแผน การตรวจสอบสภาพแวดล้อมการทำงานก็กำลังทยอยดำเนินการ
...
- 🗺 **ไม่มีอะไรต้องติดตั้ง**
  ...
  ตัว Family OS เองไม่มีโค้ดและไม่เริ่มการทำงานใด ๆ มันเป็นเพียงที่ให้อ่านแล้วเลือกหยิบ
...
| --- | --- | --- |
| **กฎ** | หลายเซสชันแย่งไฟล์เดียวกันจนพัง | [Family Dev Handbook](https://github.com/shojikumaru/family-dev-handbook) (กำลังเตรียมเปิดสู่สาธารณะ) |
| **แกนตั้ง** | ลืม หยุดกลางคัน และ "เสร็จแล้ว" ที่ตรวจสอบไม่ได้ | ใช้ [Caty Agent Harness](https://github.com/caty-ai/caty-agent-harness) (เปิดแล้ว・MIT) เป็นฐาน แล้วเติมลูปการเติบโต |
| **แกนนอน** | ความทรงจำแยกกันตามแต่ละ AI งานที่ฝากไว้หายไป | [FMA](https://github.com/shojikumaru/family-memory-architecture) (กำลังเตรียมเปิด) และ [Sitter](https://github.com/caty-ai/sitter) (เปิดแล้ว・MIT) |
...
บนฐานนั้น คุณเติมการเติบโตได้สองแบบ เอเจนต์แต่ละตัวในครอบครัวจะถือแกนตั้งนี้ตัวละหนึ่งชุด
...
เอเจนต์ที่ถือแกนตั้งแบบเดียวกันจะถูกเชื่อมในแนวนอนด้วย [Family Memory Architecture (FMA)](https://github.com/shojikumaru/family-memory-architecture) (กำลังเตรียมเปิด) มันคือชั้นที่รับผิดชอบการแบ่งปันข้อมูลภายในครอบครัวและวิธีการทำงานร่วมกัน
...
FMA และชั้นกฎบนแกนนอนยังอยู่ระหว่างเตรียมเปิด ถ้าอยากรู้ทันทีที่เปิด กด Watch รีโปนี้ไว้
