...
| **แกนตั้ง** | ลืม หยุดกลางคัน และ "เสร็จแล้ว" ที่ตรวจสอบไม่ได้ | ใช้ [Caty Agent Harness](https://github.com/caty-ai/caty-agent-harness) (เปิดแล้ว・MIT) เป็นฐาน มี [context-kit](https://github.com/caty-ai/context-kit) (กำลังเตรียมเปิด) เป็นอุปกรณ์ประจำโต๊ะ แล้วเติมลูปการเติบโตไว้ด้านบน |
...
- [context-kit](https://github.com/caty-ai/context-kit) (กำลังเตรียมเปิด) — ชุดอุปกรณ์ดูแลความสะอาดบริบท 5 ชิ้นสำหรับเอเจนต์หนึ่งตัว ได้แก่ การจำกัดขนาดผลลัพธ์ของเครื่องมือ การตรวจสอบบรีฟก่อนมอบหมายงาน การ์ดความปลอดภัย และการค้นความจำ ทุกชิ้นทำงานได้ด้วยตัวเองอย่างสมบูรณ์
