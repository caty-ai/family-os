...
<p align="center"><sub>generation: <code>596c9d5</code> (2026-08-28T12:11:09Z) · verify: <a href="https://api.github.com/repos/caty-ai/family-os/commits/main">API HEAD</a> · <a href="./status.json">status.json</a></sub></p>
<!-- repo-state:end -->
