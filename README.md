...
<p align="center"><sub>generation: <code>1b614f8</code> (2026-08-29T07:59:54Z) · verify: <a href="https://api.github.com/repos/caty-ai/family-os/commits/main">API HEAD</a> · <a href="./status.json">status.json</a></sub></p>
<!-- repo-state:end -->
