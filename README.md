...
<p align="center"><sub>generation: <code>14551f5</code> (2026-08-28T02:11:57Z) · verify: <a href="https://api.github.com/repos/caty-ai/family-os/commits/main">API HEAD</a> · <a href="./status.json">status.json</a></sub></p>
<!-- repo-state:end -->
