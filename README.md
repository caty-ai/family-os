...
- **Who is this for?** — People growing several AI agents at once. If you are still chatting with ChatGPT or Claude in the browser, or running your first single agent, this may be early for you — but if you want to take it on anyway, you are more than welcome. Start with [the problems](#problems). Hard to picture? Meet the family actually living on this map — one human and their AIs — in [our story and principles](https://github.com/caty-ai).
