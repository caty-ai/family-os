...
<p align="center"><sub>generation: <code>f135f7b</code> (2026-08-29T02:54:01Z) · verify: <a href="https://api.github.com/repos/caty-ai/family-os/commits/main">API HEAD</a> · <a href="./status.json">status.json</a></sub></p>
<!-- repo-state:end -->
