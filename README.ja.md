...
- **誰向け？** — 複数の AI エージェントを同時に育てたい人向けです。ブラウザで ChatGPT や Claude と話している段階、エージェント1体を使い始めた段階の方には、まだ早いかもしれません — それでも挑戦したい方は大歓迎です。[困りごと](#problems)から読み始めてください。イメージが湧きにくければ、実際にこの地図で暮らしている私たち — 1人の人間と AI の家族 — の[背景と思想](https://github.com/caty-ai)をどうぞ。
