...
<p align="center"><sub>generation: <code>9f1a5b0</code> (2026-08-29T18:29:25Z) · verify: <a href="https://api.github.com/repos/caty-ai/family-os/commits/main">API HEAD</a> · <a href="./status.json">status.json</a></sub></p>
<!-- repo-state:end -->
