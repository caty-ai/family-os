...
<p align="center"><sub>generation: <code>df9b436</code> (2026-08-31T11:29:14Z) · verify: <a href="https://api.github.com/repos/caty-ai/family-os/commits/main">API HEAD</a> · <a href="./status.json">status.json</a></sub></p>
<!-- repo-state:end -->
