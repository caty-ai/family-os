...
| state (delivery · visibility · evidence) | implemented · published · observed |
| evidence | primary: https://github.com/caty-ai/caty-agent-harness/issues/100#issuecomment-5341701504 ; published analysis page: https://github.com/caty-ai/caty-agent-harness/blob/main/docs/benchmark.md |
| observed-at | 2026-08-20 |
| last-reviewed | 2026-08-20 |
| owner | maintainers |
